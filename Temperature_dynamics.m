%% MATLAB Code to Simulate Temperature Dynamics with Opposite Thermal Diodes
% Simulation parameters
T0 = 300; % Initial temperature of the system (K)
C1 = 10; % Thermal capacitance of node 1 (J/K)
C2 = 10; % Thermal capacitance of node 2 (J/K)
R_forward = 0.2; % Thermal resistance in forward bias (K/W)
R_reverse_high = 5; % Reduced high thermal resistance in reverse bias (K/W)
R_reverse_breakdown = 0.2; % Thermal resistance in reverse breakdown (K/W)
...
for i = 2:length(time)
    ...
    delta_T2 = T2(i-1) - TR(i-1); % Path TR -> T2 (fixed direction)
